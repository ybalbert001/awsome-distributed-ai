...
# =============================================================================
# DATASET CONFIGURATION - Change this to use your own dataset
# =============================================================================
DATASET_NAME = "databricks/databricks-dolly-15k"
DATASET_DIR_NAME = "databricks-dolly-15k"   # This is the name of the directory that will be created in the PVC for the dataset
# When changing the dataset, you may also need to modify the _preprocess_and_split_data 
...
def get_parser():
   ...
   parser.add_argument("--seq_length", type=int, help="Sequence length", default=2048)
   parser.add_argument("--micro_batch_size", type=int, help="Micro batch size", default=1)
   parser.add_argument("--global_batch_size", type=int, help="Global batch size", default=8)
...
def custom_dataset(
    ...
    return run.Config(
        ...
        num_workers=1,
        delete_raw=False  # Disable cleanup to prevent race conditions
    )
