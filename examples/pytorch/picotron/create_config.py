...
def create_single_config(
    ...
    config_content["checkpoint"]["load_path"] = run_path
    ...
    config_content['training']['total_train_steps'] = total_train_steps
...
if __name__ == "__main__":
    ...
    parser.add_argument("--total_train_steps", type=int, help="total train steps", default=None)
    ...
    print("Running create_config.py...")
