...
The solution uses SageMaker HyperPod [Lifecycle Scripts](https://github.com/awslabs/awsome-distributed-ai/tree/main/architectures/sagemaker-hyperpod-slurm#31-lifecycle-scripts), to bootstrap your cluster with the following open-source exporter services: 
